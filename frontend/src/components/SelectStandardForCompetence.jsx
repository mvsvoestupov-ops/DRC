...
import { Search, Shield, CheckCircle2, ChevronDown, Folder } from 'lucide-react';
import { getStandards, getEnrichedStandard, getStandard, getQualificationsByStandard, calculateCoverage } from '../api';
...
const SelectStandardForCompetence = ({
  ...
  const handleSelectStandard = async (std) => {
    ...
    try {
      ...
      const qualsRes = await getQualificationsByStandard(std.id);
