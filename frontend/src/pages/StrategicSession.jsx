...
import Step1SelectStandard from '../components/strategic/Step1SelectStandard';
import Step2StructureABC from '../components/strategic/Step2StructureABC';
import Step3Descriptors from '../components/strategic/Step3Descriptors';
import Step4DisciplineMapping from '../components/strategic/Step4DisciplineMapping';
import Step5EdTech from '../components/strategic/Step5EdTech';
import Step6AssessmentTools from '../components/strategic/Step6AssessmentTools';
import Step7Resources from '../components/strategic/Step7Resources';
import Step8Validation from '../components/strategic/Step8Validation';
import Step9Revision from '../components/strategic/Step9Revision';
import Step10Preview from '../components/strategic/Step10Preview';
...
const StrategicSession = () => {
  ...
  const handleFinish = async () => {
    setLoading(true);
    try {
      // Преобразуем assessment_tools из объекта в массив
      const toolsArray = [];
  ...
  return (
    <div style={{ padding: '24px', background: '#fff', minHeight: '100vh' }}>
      <Title level={2}>Стратегическая сессия: разработка компетенции</Title>
